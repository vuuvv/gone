...
type StringTree = Tree[string, any]
...
// NewWithIntKey instantiates a red-black tree with the IntComparator, i.e. keys are of type int.
func NewWithIntKey[V any]() *Tree[int, V] {
	return &Tree[int, V]{Comparator: utils.IntComparator}
}

// NewWithStringKey instantiates a red-black tree with the StringComparator, i.e. keys are of type string.
func NewWithStringKey[V any]() *Tree[string, V] {
